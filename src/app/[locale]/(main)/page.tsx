...
export default async function Index(props: IIndexProps) {
  ...
  const hasStripe =
    !STRIPE_INTEGRATION_TYPE.startsWith("__") &&
    (STRIPE_INTEGRATION_TYPE === "OneTime" ||
      STRIPE_INTEGRATION_TYPE === "Subscriptions");
  const hasAuth = !AUTH_TYPE.startsWith("__");
  const hasEmail =
    !EMAIL_INTEGRATION.startsWith("__") && EMAIL_INTEGRATION.length > 0;
  const hasDashboard =
    !DASHBOARD_MESSAGE.startsWith("__") && DASHBOARD_MESSAGE.length > 0;
  const hasPwa = !PWA_MESSAGE.startsWith("__") && PWA_MESSAGE.length > 0;
  const hasStorybook =
    !STORYBOOK_MESSAGE.startsWith("__") && STORYBOOK_MESSAGE.length > 0;
  const showDarkToggle =
    !DARK_MODE_ENABLED.startsWith("__") && DARK_MODE_ENABLED === "true";
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mb-32 text-center">
          ...
          <div className="mb-8 space-y-4">
            <h1 className="text-5xl font-bold leading-tight tracking-tight md:text-6xl lg:text-7xl xl:text-8xl">
              ...
              <span className="text-futuristic block">Atlas Online Store</span>
            </h1>
          </div>

          {/* Subtitle */}
          <p className="mx-auto mb-6 max-w-4xl text-xl leading-relaxed text-muted-foreground md:text-2xl">
            A modern e-commerce platform with TypeScript, Tailwind CSS, and
            authentication.
            <span className="mt-2 block font-semibold text-foreground">
              Built for businesses who want to sell online.
            </span>
          </p>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M12 11c1.657 0 3-1.343 3-3S13.657 5 12 5 9 6.343 9 8s1.343 3 3 3zm0 2c-2.761 0-5 2.239-5 5v1h10v-1c0-2.761-2.239-5-5-5z"
                        />
                      </svg>
                    </div>
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        ...
                        {AUTH_TYPE === "SupabaseRoles" &&
                          "Supabase Auth with Roles configured"}
                      </p>
                      {AUTH_TYPE === "None" ? (
                        <a
                          href="/sign-in"
                    ...
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900/50">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M3 3h18M9 7h12M9 11h12M9 15h12M3 7h4M3 11h4M3 15h4"
                        />
                      </svg>
                    </div>
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        Explore analytics and UI widgets
                      </p>
                      <a
                        href="/dashboard"
                        className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:text-primary/80 transition-colors"
                ...
                <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm p-6 transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        Install the app and enjoy offline support
                      </p>
                    </div>
                  </div>
                ...
                <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm p-6 transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        Run <code>npm run storybook</code> to explore UI
                        components
                      </p>
                    </div>
                  </div>
          ...
          <div className="relative">
            ...
            <div
              className="animate-pulse-slow absolute -right-20 top-0 size-32 rounded-full bg-primary/10 blur-3xl"
        ...
        <div className="mb-32">
          <div className="mb-16 text-center">
            <h2 className="mb-6 text-4xl font-bold text-foreground md:text-5xl">
              ...
              <span className="text-futuristic block">Build Fast</span>
            </h2>
            <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
              Comprehensive tooling and modern architecture patterns for
            ...
            {[
              {
                title: "Next.js 15",
                description:
                  "Built with the latest Next.js App Router for optimal performance and cutting-edge features.",
                icon: "⚡",
              ...
              },
              {
                title: "Tailwind CSS",
                description:
                  "Beautiful, responsive design with Tailwind CSS and modern UI components.",
                icon: "🎨",
              ...
              },
              {
                ...
                description:
                  "Multi-language support with next-intl for building global applications.",
                icon: "🌍",
              ...
              },
              {
                ...
                description:
                  "ESLint, Prettier, Husky, and comprehensive testing setup for smooth development.",
                icon: "🛠️",
        ...
        <div className="mb-32">
          <div className="text-center">
            <h2 className="mb-6 text-4xl font-bold text-foreground md:text-5xl">
              Built with
              <span className="text-futuristic block">Modern Technologies</span>
            </h2>
            <p className="mx-auto mb-16 max-w-3xl text-lg text-muted-foreground">
              Leveraging the best tools and frameworks to ensure your project is
        ...
        <Card className="border-futuristic mb-24 border-0 bg-gradient-to-br from-muted/20 via-muted/30 to-muted/20 p-16 text-center backdrop-blur-sm">
          <CardHeader className="pb-8">
            <CardTitle className="text-4xl font-bold text-foreground md:text-5xl">
              ...
              <span className="text-futuristic block">Amazing?</span>
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-8">
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              Start your next project with our production-ready boilerplate and
